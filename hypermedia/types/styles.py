...
CSSProperties = TypedDict(
    "CSSProperties",
    {
        ...
        "background-clip": Literal[
            "border-box", "padding-box", "content-box", "text"
        ],
        "background-color": str,
        "background-image": str,
        "background-origin": Literal[
        ...
        "padding-right": str,
        "padding-top": str,
        "page-break-after": Literal[
            "auto", "always", "avoid", "left", "right"
        ],
        "page-break-before": Literal[
            "auto", "always", "avoid", "left", "right"
        ],
